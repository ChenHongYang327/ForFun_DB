...
public class OtherPay {
	...
	public OtherPay(Integer otherpayId, Integer agreementId, Integer otherpayMoney, String otherpayNote,
			String suggestImg, Integer otherpayStatus, Timestamp createTime, Timestamp deleteTime) {
		super();
